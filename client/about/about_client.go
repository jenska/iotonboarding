...
type ClientService interface {
	GetAboutUsingGET1(params *GetAboutUsingGET1Params, authInfo runtime.ClientAuthInfoWriter) (*GetAboutUsingGET1OK, error)

	SetTransport(transport runtime.ClientTransport)
}

/*
  GetAboutUsingGET1 returns service information
*/
func (a *Client) GetAboutUsingGET1(params *GetAboutUsingGET1Params, authInfo runtime.ClientAuthInfoWriter) (*GetAboutUsingGET1OK, error) {
